...
def upgrade():
    op.create_table('files',
        ...
        sa.Column('file_type', sa.Enum('other', 'video', 'audio', 'photo', 'text', name='filetypeenum'), nullable=False),
        sa.Column('date_added_to_collection', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    ...
    op.create_table('medias',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('name', sa.String(), nullable=False),
        sa.Column('media_type', sa.Enum('HDD', 'CD', 'DVD', 'BR', 'CLOUD', 'TAPE', name='mediatypeenum'), nullable=False),
    ...
    op.create_table('media_file_associations',
